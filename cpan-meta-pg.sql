...
CREATE INDEX IF NOT EXISTS "packages_package_idx" ON "packages" (lower("package"));
...
CREATE INDEX IF NOT EXISTS "perms_userid_best_permission_idx" ON "perms" (lower("userid"),"best_permission");
CREATE INDEX IF NOT EXISTS "perms_package_best_permission_idx" ON "perms" (lower("package"),"best_permission");
...
CREATE INDEX IF NOT EXISTS "authors_cpanid_idx" ON "authors" (lower("cpanid"));
